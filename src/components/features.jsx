...
const BentoTilt = ({ children, className = '' }) => {
    ...
    const handleMouseMove = (e) => {
        ...
        const transformStyle = `perspective(700px) rotateX(${tiltX}deg) rotateY(${tiltY}deg) scale3d(0.98, 0.98, 0.98)`;
...
const Features = () => {
    return (
        <section className='bg-black pb-52'>
            <div className='contaniner mx-auto px-3 md:px-10'>
                <div className='px-5 py-32'>
                    <p className='font-circular-web font-semibold text-lg text-blue-50'>Into the Metagame</p>

                    <p className='font-circular-web max-w-md opacity-50 text-lg text-blue-50'>
                ...
                <div className='grid h-[135vh] grid-cols-2 grid-row-3 gap-7'>
                    ...
                    <BentoTilt className='bento-tilt_2'>
                        <div className='flex size-full flex-col justify-between bg-violet-300 p-5'>
                            <h1 className='bento-title special-font max-w-64 text-black'>m<b>0</b>re <b>c</b>oming s<b>0</b>on!</h1>
